...
#define WIFI_SSID        "wifilink"          //WiFi SSID name
#define WIFI_PASSWORD  "kmvgrp99644"         //WiFi Pasword

///////*     Access  Token From CLOUD   *////////////

#define TOKEN "7N2GnrXTXIV5eG3fxVgf"                    //access Token ID from the Server
